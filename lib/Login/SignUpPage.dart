      ...
      child: Row(
        children: [
          TextButton(
              ...
              child: Text("Ingresar", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.grey),)
          ),
          Text("/",style: TextStyle(fontSize: 25,color: Colors.grey),),
          TextButton(
              onPressed: ()=>Navigator.pushNamed(context, "registrarse"),
              child: Text("Registrarse", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color: Colors.black),)
          ),
        ],
      ),
    );
